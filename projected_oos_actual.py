        ...
        if date >= change_date:
            ...
            if days_after_change == 0:
                ...
                if 60000 <= custom_stl_supply < 80000:
                    entry["Projected OOS%"] = max(0, round(forecast_value*1.3 / 20000 * (1 - supply_factor), 2)) 
                else:
                    entry["Projected OOS%"] = max(0, round(forecast_value*1.3 / 22000 * (1 - supply_factor), 2))#1.125
