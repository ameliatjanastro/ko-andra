...
custom_kos_supply = st.number_input("KOS SO", min_value=90000, value=100000, step=5000, max_value=110000)
custom_stl_supply = st.number_input("STL SO", min_value=60000, value=80000, step=5000, max_value=120000)
